...
const Header = () => {
  return (
    <header className="header h-[70px] bg-bg fixed left-60 top-0 right-0 px-[59px] flex justify-between">
      <div className="header-left h-full flex flex-grow items-center">
        ...
        <form className="search w-full max-w-[540px]">
          <div className="search-container h-10 flex items-center">
            ...
            <div className="input-wrapper w-full">
              <input
                className="w-full bg-transparent text-white py-1"
                type="text"
      ...
      <div className="header-right flex grow-0 items-center">
